...
import { advanceChar, toHex, NumberKind } from './common.mjs';
import { CharTypes, CharFlags, isIdentifierStart } from './charClassifier.mjs';
import { Chars } from '../chars.mjs';
import { report, Errors, reportScannerError } from '../errors.mjs';
