...
exports.scanRegularExpression = void 0;
...
function scanRegularExpression(parser, context) {
  ...
  loop: while (true) {
    ...
    if (preparseState & 1) {
      ...
      switch (ch) {
        ...
        case 8232:
        case 8233:
          (0, errors_1.report)(parser, 32);
        default:
      }
    }
    if (parser.index >= parser.source.length) {
      return (0, errors_1.report)(parser, 32);
    }
  }
  ...
  while ((0, charClassifier_1.isIdentifierPart)(_char)) {
    switch (_char) {
      case 103:
        if (mask & 2) (0, errors_1.report)(parser, 34, 'g');
        mask |= 2;
        break;
      case 105:
        if (mask & 1) (0, errors_1.report)(parser, 34, 'i');
        mask |= 1;
        break;
      case 109:
        if (mask & 4) (0, errors_1.report)(parser, 34, 'm');
        mask |= 4;
        break;
      case 117:
        if (mask & 16) (0, errors_1.report)(parser, 34, 'u');
        mask |= 16;
        break;
      case 121:
        if (mask & 8) (0, errors_1.report)(parser, 34, 'y');
        mask |= 8;
        break;
      case 115:
        if (mask & 32) (0, errors_1.report)(parser, 34, 's');
        mask |= 32;
        break;
      case 100:
        if (mask & 64) (0, errors_1.report)(parser, 34, 'd');
        mask |= 64;
        break;
      default:
        (0, errors_1.report)(parser, 33);
    }
