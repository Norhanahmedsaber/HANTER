...
var _reporter = _interopRequireDefault(require("./reporter/reporter.js"));
...
var _evaluate = _interopRequireDefault(require("./matcher/evaluate.js"));
...
function hanter() {
  var rules = (0, _get_rules["default"])();
  var _iterator = _createForOfIteratorHelper(rules),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var rule = _step.value;
      rule = (0, _rules_parser["default"])(rules);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
  ...
  var sourceFiles = (0, _file_traverser["default"])('./', (0, _parsingconfig["default"])());
