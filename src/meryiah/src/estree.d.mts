...
export type Expression = ArrowFunctionExpression | AssignmentExpression | BinaryExpression | ConditionalExpression | MetaProperty | ChainExpression | JSXClosingElement | JSXClosingFragment | JSXExpressionContainer | JSXOpeningElement | JSXOpeningFragment | JSXSpreadChild | LogicalExpression | NewExpression | RestElement | SequenceExpression | SpreadElement | AwaitExpression | LeftHandSideExpression | UnaryExpression | UpdateExpression | YieldExpression | General | MetaVariable;
...
export type PrimaryExpression = MetaVariable | ArrayExpression | ArrayPattern | ClassExpression | FunctionExpression | Identifier | Import | JSXElement | JSXFragment | JSXOpeningElement | Literal | LiteralExpression | MetaProperty | ObjectExpression | ObjectPattern | Super | TemplateLiteral | ThisExpression;
export type PrimaryExpressionExtended = MetaVariable | ArrayExpression | ArrowFunctionExpression | ArrayPattern | AwaitExpression | Expression | ClassExpression | FunctionExpression | Identifier | Import | JSXElement | JSXFragment | JSXOpeningElement | Literal | LiteralExpression | MetaProperty | ObjectExpression | ObjectPattern | PrivateIdentifier | NewExpression | Super | TemplateLiteral | ThisExpression | UnaryExpression | UpdateExpression;
...
interface ClassDeclarationBase extends _Node {
    id: Identifier | MetaVariable | null;
    body: ClassBody;
...
export interface MetaVariable extends _Node {
    type: 'MetaVariable';
    name: string;
}
...
export interface AssignmentPattern extends _Node {
    ...
    left: BindingPattern | Identifier | MetaVariable;
    right?: Expression;
}
...
export interface BreakStatement extends _Node {
    type: 'BreakStatement';
    label: Identifier | MetaVariable | null;
}
...
export interface ChainExpression extends _Node {
    ...
    expression: CallExpression | MetaVariable | MemberExpression;
}
...
export interface CatchClause extends _Node {
    type: 'CatchClause';
    param: BindingPattern | Identifier | MetaVariable | null;
    body: BlockStatement;
}
...
export interface ExportAllDeclaration extends _Node {
    ...
    source: Literal;
    exported: Identifier | MetaVariable | null;
}
...
export interface ExportSpecifier extends _Node {
    ...
    local: Identifier | MetaVariable;
    exported: Identifier | MetaVariable;
}
...
export interface ImportSpecifier extends _Node {
    ...
    local: Identifier | MetaVariable;
    imported: Identifier | MetaVariable;
}
...
export type Pattern = Identifier | MetaVariable | ObjectPattern | ArrayPattern | RestElement | AssignmentPattern | MemberExpression;
export interface MetaProperty extends _Node {
    type: 'MetaProperty';
    meta: Identifier | MetaVariable;
    property: Identifier | MetaVariable;
}
...
export interface Property extends _Node {
    type: 'Property';
    key: Expression;
    value: Expression | AssignmentPattern | BindingPattern | Identifier | MetaVariable;
    computed: boolean;
    method: boolean;
    shorthand: boolean;
    kind: 'init' | 'get' | 'set';
...
export type SpreadArgument = BindingPattern | Identifier | MetaVariable | Expression | PropertyName | SpreadElement;
...
export interface VariableDeclarator extends _Node {
    ...
    id: Expression | BindingPattern | Identifier | MetaVariable;
...
export {};
//# sourceMappingURL=estree.d.mts.map