      ...
      switch (token) {
        ...
        case 67108877:
          ...
          if (next === 46) {
            ...
            if (_index2 < parser.end && source.charCodeAt(_index2) === 46 && source.charCodeAt(_index2 + 1) === 46 && source.charCodeAt(_index2 + 2) === 46) {
              parser.column += 4;
        ...
        case 143500:
          (0, _common.advanceChar)(parser);
          return (0, _identifier.scanMetaVariable)(parser, context, 0);
        case 8455240:
          {
            (0, _common.advanceChar)(parser);
        ...
        case 22:
          {
            ...
            if (_ch10 === 46) {
              ...
              if (_index3 < parser.end) {
                _ch10 = source.charCodeAt(_index3);
